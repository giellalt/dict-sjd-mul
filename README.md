# Dictionary for sjd — mul

This repository contains source files for a dictionary from Kildin Saami to Multiple languages. The content is licensed under the  license.
